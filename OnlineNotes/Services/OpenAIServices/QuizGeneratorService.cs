...
namespace OnlineNotes.Services.OpenAIServices
{
    public class QuizGeneratorService : IQuizGeneratorService
    {
        ...
        public string FakeGenerateQuiz(string noteTitle)
        {
            switch (noteTitle) // these quizzes were really generated by chatgpt api previously
            {
                case "Stork":
        ...
        public async Task<string> GenerateQuiz(string noteContents, QuizDifficulty difficulty, int questionsCount) // DO NOT USE THIS METHOD IN THIS STATE. IT GENERATES A LOT OF API CALLS
        {
            //try
            //{
